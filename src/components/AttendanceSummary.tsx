...
export function AttendanceReview(props: AttendanceSummaryProps) {
  return <div className="intake-review"><div className="intake-section-heading"><span>03 / CONFERÊNCIA</span><h3>Está tudo certo?</h3><p>Confira os dados antes de abrir a ordem de serviço.</p></div>
    ...
    <p className="intake-confirm-note"><Icon name="check" size={20}/><span>A OS será aberta em <b>Em avaliação</b>. {props.reserveNow ? "As peças incluídas serão baixadas do estoque ao abrir." : "A baixa das peças aguarda o início do serviço."} Nenhum pagamento será lançado agora.</span></p>
  </div>;
}
